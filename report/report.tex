...
\myparagraph{Extremal Perturbation Implementation for HMT}
\begin{figure}[t]
	\includegraphics[width=\textwidth]{images/hmt-ep-successes}
	\caption{\label{fig:hmt-ep-successes}Class-wise accuracy on HMT\@.}
\end{figure}
...
Note that for the implementation I referred to \href[https://github.com/facebookresearch/TorchRay]{TorchRay}'s extremal perturbations.
But, the conversion to 1D for MNIST-1D, and to TensorFlow for both MNIST-1D and HMT, was non-trivial and required significant effort.
